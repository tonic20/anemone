...
See the scripts under the <tt>lib/anemone/cli</tt> directory for examples of several useful Anemone tasks.
	...
	Anemone.crawl("http://www.somedomain.com/") do |anemone|
	  anemone.storage = Anemone::Storage.MongoDB
	  anemone.flush = false #default
	  anemone.persist_queue = true #redis
...
== Requirements
* nokogiri
* robots (work only with http://github.com/tonic20/robots fork)
