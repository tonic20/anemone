...
module Anemone
  ...
  class Core
    ...
    DEFAULT_OPTS = {
      ...
      # Also you should init storage like:
      #   Anemone.crawl(url) do |crawler|
      #     crawler.storage = Anemone::Storage.MongoDB(Mongo::Connection.new.db(Mongoid::Config.master.name), "pages", flush: false)
      #   end
      #
      :flush => false,
